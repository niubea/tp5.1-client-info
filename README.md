...
[![Latest Stable Version](http://img.shields.io/packagist/v/czt/agent.svg)](https://packagist.org/packages/czt/agent) [![Total Downloads](http://img.shields.io/packagist/dm/czt/agent.svg)](https://packagist.org/packages/czt/agent) [![Build Status](http://img.shields.io/travis/czt/agent.svg)](https://travis-ci.org/czt/agent) [![Coverage Status](http://img.shields.io/coveralls/czt/agent.svg)](https://coveralls.io/r/czt/agent) [![Donate](https://img.shields.io/badge/donate-paypal-blue.svg)](https://www.paypal.me/czt)
...
<p align="center">
<img src="http://czt.be/uploads/images/agent.png?v4" height="275">
</p>
...
```php
czt\Agent\AgentServiceProvider::class,
```

And add the Agent alias to `config/app.php`:

```php
'Agent' => czt\Agent\Facades\Agent::class,
```
